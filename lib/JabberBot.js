...
function JabberBot(configuration) {
    ...
    if (configuration.storage) {
        if (!(
            configuration.storage.teams.all &&
            configuration.storage.teams.delete &&

            configuration.storage.users.all &&
            configuration.storage.users.delete &&

            configuration.storage.channels.all &&
            configuration.storage.channels.delete
        )) {
